  ...
  return (
    <section className='my-28' id='contact'>
      <header className='px-5 text-2xl font-bold pt-10'>
        <h2>Contact</h2>
        {/* <p className='text-base font-thin'>저와 더 이야기해보고 싶으신가요?</p> */}
      </header>
      <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between'>
        <div className='md:w-6/12 md:px-0 p-5 my-5'>
          <div>
            <p className='font-bold'>윤정윤</p>
            <p className='font-thin'>고려대학교 NEXT 멋쟁이사자처럼 10기</p>
            <a href='mailto: jungyoon9328@korea.ac.kr' className='border-b-2 mt-3 inline-block border-gray-500'>
              jungyoon9328@korea.ac.kr
            </a>
          </div>
